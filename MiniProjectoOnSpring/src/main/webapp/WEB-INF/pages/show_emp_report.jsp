...
<tr>
<th> emp no</th> <th> emp name</th><th> desn</th> <th>salary</th><th colspan="2">operation</th>
</tr>
...
<td><a href="employee_delete?no=${emp.empno}" onclick="return confirm ('Do u want to delete?')"><img src="resources/images/delete.jpeg" width="30px" height="30px"></a></td>
 ...
 <c:otherwise>
<h1 style="color:red;textt-align:center">Records not found</h1> 
</c:otherwise>
 
</c:choose>

<h1 style="text:red;text-align:center"><a href="employee_add"> <img src="resources/images/add.jpeg" width="50px" height="50px"/></a> </h1>
<br><br>
<h1 style="text-align:center">${resultMsg }</h1>

<center><a href="./"> <img src="resources/images/home.jpeg" width="50px" height="50px"/></a></center> 
